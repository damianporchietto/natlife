...
echo "3. Push to trigger release: git push origin master"
echo "   → This will create GitHub tag AND Docker images:"
echo "   → ghcr.io/YOUR_REPO/natlife:v$NEW_VERSION"
echo "   → ghcr.io/YOUR_REPO/natlife:latest"
